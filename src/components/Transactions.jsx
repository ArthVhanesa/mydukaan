...
export default function Transactions() {
  return (
    <>
      <div className="mb-5 mt-2 text-zinc-900 text-xl font-medium font-GalanoGrotesque-medium font-['Galano Grotesque'] leading-7">
      ...
      <div className="w-[238px] h-8 justify-start items-start gap-3 inline-flex">
        <div className="cursor-pointer px-4 py-1.5 bg-sky-700 rounded-[40px] justify-start items-center gap-1.5 flex">
          <div className="text-white text-sm font-medium font-GalanoGrotesque-medium font-['Galano Grotesque'] leading-tight">
            Payouts (22)
          </div>
        </div>
        <div className="cursor-pointer px-4 py-1.5 bg-neutral-200 rounded-[40px] justify-start items-center gap-2.5 flex">
          <div className="text-zinc-500 text-sm font-medium font-GalanoGrotesque-medium font-['Galano Grotesque'] leading-tight">
            Refunds (2)
          </div>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-neutral-100">
              ...
              <th className="text-right p-3 rounded-r-lg text-neutral-600 w-1/6 font-medium font-GalanoGrotesque-medium">
                Total
              </th>
            </tr>
          </thead>
          ...
          <tbody>
            <tr className="">
              <td className="text-left p-3 text-sky-700 border-b text-sm font-medium font-GalanoGrotesque-medium">
                Today, 09:00 PM
              </td>
              <td className="text-left p-3 border-b">
                <div className="flex justify-start items-center">
                  <div className="w-2.5 h-2.5 bg-neutral-400 rounded-full mr-1.5" />
                  <div className="text-zinc-900 text-sm font-normal font-GalanoGrotesque-regular font-['Galano Grotesque'] leading-tight">
                    Processing
                  </div>
                </div>
              </td>
            ...
            <tr className="">
              <td className="text-left p-3 text-sky-700  text-sm font-medium font-GalanoGrotesque-medium">
              ...
              <td className="text-left p-3  text-zinc-900 text-sm font-normal font-GalanoGrotesque-regular">
                131634495747
              </td>
              <td className="text-right p-3  text-zinc-900 text-sm font-normal font-GalanoGrotesque-regular">
                ₹10,125.00
              </td>
              <td className="text-right p-3  text-zinc-900 text-sm font-normal font-GalanoGrotesque-regular">
                ₹1,125.00
